...
void loop() {
  ...
  for (int i = 0; i < 3; i++) {
    ...
    sys[i].LEDloop();
    lightSensorState[i] = getLightSensorState(i);
  }
  processingTime = 0;
  for (int i = 0; i < 100; i++) {
  ...
  String printMessage = "";
  printMessage = (String)"Door State:" +
                 (String)"\nDoor 1: " + printDoorState(doorState[0]) +
                 (String)"\nDoor 2: " + printDoorState(doorState[1]) +
                 (String)"\nDoor 3: " + printDoorState(doorState[2]) +
                 (String)"\nQueuing length: " + (String)printQueuingLength(lightSensorState);
